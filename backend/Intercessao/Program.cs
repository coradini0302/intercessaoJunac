...
static async Task ApplySchemaPatches(AppDbContext db)
{
    ...
    string[] patches = isPostgres
        ? [
            ...
            """CREATE TABLE IF NOT EXISTS "Formacoes" ("Id" SERIAL PRIMARY KEY,"Titulo" VARCHAR(200) NOT NULL,"Conteudo" TEXT NOT NULL,"CriadoPorId" TEXT NOT NULL,"CriadoEm" TIMESTAMPTZ NOT NULL,"AtualizadoEm" TIMESTAMPTZ)""",
        ...
        : [
            ...
            "CREATE TABLE IF NOT EXISTS Formacoes (Id INTEGER PRIMARY KEY AUTOINCREMENT,Titulo TEXT NOT NULL,Conteudo TEXT NOT NULL,CriadoPorId TEXT NOT NULL,CriadoEm TEXT NOT NULL,AtualizadoEm TEXT)",
            "CREATE TABLE IF NOT EXISTS DinamicasMembros (Tipo INTEGER NOT NULL,UsuarioId TEXT NOT NULL,PRIMARY KEY (Tipo,UsuarioId))",
